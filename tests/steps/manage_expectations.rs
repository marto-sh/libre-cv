...
fn link_experience_to_expectation(world: &mut ProfessionalIdentityWorld) {
    let identity = world.identity.as_mut().expect("identity should exist");
    ...
    let expectation_id = world
        ...
        .expect("should have a current expectation");
    identity
        .link_experience_to_expectation(experience_id, expectation_id)
        .expect("should link");
}

#[given("the Owner has linked the experience to the expectation")]
fn given_experience_linked_to_expectation(world: &mut ProfessionalIdentityWorld) {
...
fn expectation_should_reference_experience(world: &mut ProfessionalIdentityWorld) {
    let identity = world.identity.as_ref().expect("identity should exist");
    let expectation_id = world
        .current_expectation_id
        .as_ref()
    ...
    assert!(
        ...
        "Expectation should reference the experience"
    );
}

#[then("the experience should reference the expectation")]
fn experience_should_reference_expectation(world: &mut ProfessionalIdentityWorld) {
    let identity = world.identity.as_ref().expect("identity should exist");
    let experience_id = world
        .current_experience_id
        .as_ref()
